create or replace
PROCEDURE Tmp_Log_stats_SP (start_date VARCHAR2,	end_date  VARCHAR2)
  AS
...
BEGIN
  ...
  nCheckpoint := 2;
  EXECUTE IMMEDIATE q'[INSERT INTO Tmp_Log_stats (sWarehouse, sCust, nTotal, sType)
