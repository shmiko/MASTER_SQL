create or replace PACKAGE           "EOM_REPORTING" AS 

  /* TODO enter package declarations (types, exceptions, methods etc) here */ 
   PROCEDURE A_EOM_GROUP_CUST(sOp IN VARCHAR2);
...
create or replace PACKAGE BODY           "EOM_REPORTING" AS
   ...
   RETURN;
     ...
     -- End If;
      ...
      SELECT    s.SH_CUST                AS "Customer",
          ...
          CASE  WHEN  d.SD_SELL_PRICE >= 0.1 AND   d.SD_ADD_OP = 'RV'  THEN 'Manual Freight Fee'
                ...
                WHEN  d.SD_ADD_OP != 'RV' AND   d.SD_ADD_OP != 'SERV2' AND d.SD_XX_FREIGHT_CHARGE > 0.1 THEN 'XX Manual Freight Fee'
                WHEN  d.SD_ADD_OP = 'SERV2' AND d.SD_XX_FREIGHT_CHARGE > 0.1 THEN 'XX? Manual Freight Fee'
          ...
          CASE  WHEN  d.SD_SELL_PRICE >= 0.1 AND   d.SD_ADD_OP = 'RV'  THEN f_calc_freight_fee(d.SD_SELL_PRICE,TRIM(d.SD_NOTE_1),r.sGroupCust,d.SD_ORDER) 
                ...
                WHEN  d.SD_ADD_OP != 'RV' AND   d.SD_ADD_OP != 'SERV2' AND d.SD_XX_FREIGHT_CHARGE > 0.1 THEN f_calc_freight_fee(d.SD_XX_FREIGHT_CHARGE,TRIM(d.SD_NOTE_1),r.sGroupCust,d.SD_ORDER)
                WHEN  d.SD_ADD_OP = 'SERV2' AND d.SD_XX_FREIGHT_CHARGE > 0.1 THEN f_calc_freight_fee(d.SD_XX_FREIGHT_CHARGE,TRIM(d.SD_NOTE_1),r.sGroupCust,d.SD_ORDER)
          ...
          CASE  WHEN  d.SD_SELL_PRICE >= 0.1 AND   d.SD_ADD_OP = 'RV'  THEN f_calc_freight_fee(d.SD_SELL_PRICE,TRIM(d.SD_NOTE_1),r.sGroupCust,d.SD_ORDER) * 1.1
                ...
                WHEN  d.SD_ADD_OP != 'RV' AND   d.SD_ADD_OP != 'SERV2' AND d.SD_XX_FREIGHT_CHARGE > 0.1 THEN f_calc_freight_fee(d.SD_XX_FREIGHT_CHARGE,TRIM(d.SD_NOTE_1),r.sGroupCust,d.SD_ORDER) * 1.1
                WHEN  d.SD_ADD_OP = 'SERV2' AND d.SD_XX_FREIGHT_CHARGE > 0.1 THEN f_calc_freight_fee(d.SD_XX_FREIGHT_CHARGE,TRIM(d.SD_NOTE_1),r.sGroupCust,d.SD_ORDER) * 1.1
                ...
                ELSE d.SD_INCL   
          END AS "DIncl",
          d.SD_XX_FREIGHT_CHARGE                   AS "ReportingPrice",
          ...
          d.SD_XX_FREIGHT_CHARGE
    FROM  PWIN171.SD d
          INNER JOIN PWIN171.SH s  ON s.SH_ORDER  = d.SD_ORDER
          LEFT OUTER JOIN PWIN171.ST t  ON LTRIM(RTRIM(t.ST_PICK))  = LTRIM(RTRIM(d.SD_XX_PICKLIST_NUM))
    ...
    GROUP BY  
          ...
          d.SD_XX_PICKLIST_NUM,d.SD_QTY_ORDER,d.SD_QTY_ORDER,d.SD_ORDER,d.SD_XX_FREIGHT_CHARGE,d.SD_COST_PRICE,d.SD_NOTE_1,d.SD_COST_PRICE,
          d.SD_STOCK,d.SD_ADD_OP,d.SD_DESC,d.SD_LINE,d.SD_EXCL,d.SD_INCL,d.SD_NOTE_1,d.SD_SELL_PRICE,d.SD_XX_OW_UNIT_PRICE,d.SD_XX_FREIGHT_CHARGE,
     ...
     SELECT    s.SH_CUST                AS "Customer",
          ...
          substr(To_Char(d.SD_ADD_DATE),0,10)            AS "DespatchDate",
          substr(To_Char(s.SH_ADD_DATE),0,10) AS "OrderDate",
          CASE  WHEN d.SD_XX_FREIGHT_CHARGE >= 0.1  THEN 'XX Van Manual Freight Fee'
          ...
          CASE  WHEN d.SD_LINE IS NOT NULL THEN  '1'
                ELSE NULL
          END                      AS "UOI",
         f_calc_freight_fee(d.SD_XX_FREIGHT_CHARGE,TRIM(d.SD_NOTE_1),r.sGroupCust,d.SD_ORDER) AS "UnitPriceMarkedUp", 
          CASE  WHEN d.SD_SELL_PRICE >= 1 THEN f_calc_freight_fee(d.SD_XX_FREIGHT_CHARGE,TRIM(d.SD_NOTE_1),r.sGroupCust,d.SD_ORDER)      
          ELSE d.SD_XX_FREIGHT_CHARGE   
          END AS "OWUnitPrice",
          CASE  WHEN d.SD_XX_FREIGHT_CHARGE >= 1 THEN f_calc_freight_fee(d.SD_XX_FREIGHT_CHARGE,TRIM(d.SD_NOTE_1),r.sGroupCust,d.SD_ORDER)      
          ELSE d.SD_EXCL   
          END AS "DExcl",
          CASE  WHEN d.SD_XX_FREIGHT_CHARGE >= 1 THEN f_calc_freight_fee(d.SD_XX_FREIGHT_CHARGE,TRIM(d.SD_NOTE_1),r.sGroupCust,d.SD_ORDER) * 1.1     
          ELSE d.SD_INCL   
          END AS "DIncl",
          d.SD_XX_FREIGHT_CHARGE                   AS "ReportingPrice",
          CASE  WHEN regexp_substr(SD_NOTE_1,'\d') IS NOT NULL THEN TO_NUMBER(SD_NOTE_1) --TO_NUMBER(d.SD_NOTE_1,'fm999999.99999999','nls_numeric_characters = ''.,''')      
  ...
  /* Van Manual freight fees*/
    ...
    FROM      PWIN171.SD d
          ...
          LEFT JOIN Tmp_Group_Cust r ON r.sCust = s.SH_CUST
          --INNER JOIN PWIN171.SD d2 ON d.SD_ORDER  = d2.SD_ORDER
   ...
   -- AND 
    ...
    GROUP BY  s.SH_CUST,
          ...
          s.SH_POST_CODE,
          s.SH_NOTE_1,
          s.SH_NOTE_2,d.SD_ORDER,d.SD_XX_FREIGHT_CHARGE,
          --t.ST_WEIGHT,
         -- t.ST_PACKAGES,
  ...
  --USING ;
   ...
   -- sCust_Rates2 RM.RM_XX_FEE12%TYPE;
    ...
    --nCheckpoint := 11;
          ...
          If (sOp = 'PRJ' or sOp = 'PRJ_TEST') Then
            ...
            EXECUTE IMMEDIATE v_query;
            If (sCustomerCode != 'IAG')AND (sAnalysis != 'VICP') Then
                OPEN c;
                ----DBMS_OUTPUT.PUT_LINE(sCust || '.' );
                LOOP
                FETCH c BULK COLLECT INTO l_data LIMIT p_array_size;
    ...
    PROCEDURE E0_ALL_ORD_FEES (
      ...
      SELECT    s.SH_CUST,r.sGroupCust,
          ...
          s.SH_XX_FEE_WAIVE,d.SD_COST_PRICE,
          s.SH_SPARE_INT_4,s.SH_CAMPAIGN,
          d.SD_NOTE_1,d.SD_COST_PRICE,d.SD_XX_FREIGHT_CHARGE
    FROM  PWIN171.SH s
   ...
   --AND       t.ST_DESP_DATE >= startdate AND t.ST_DESP_DATE <= enddate
    ...
    GROUP BY   s.SH_CUST,r.sGroupCust,i.IM_CUST,s.SH_SPARE_STR_4,i.IM_XX_COST_CENTRE01,
          ...
          s.SH_SPARE_INT_4,s.SH_CAMPAIGN,
          d.SD_NOTE_1,d.SD_COST_PRICE,
          d.SD_XX_FREIGHT_CHARGE,s.SH_ADD_DATE,d.SD_COST_PRICE,
...
*/
  ...
  --	AND       TO_CHAR(t.ST_DESP_DATE,'YYYY-MM-DD') >= start_date AND TO_CHAR(t.ST_DESP_DATE,'YYYY-MM-DD') <= end_date
    ...
    PROCEDURE G2_STOCK_FEES (
      ...
      SELECT 
          ...
          substr(To_Char(s.SH_ADD_DATE),0,10) AS "OrderDate",
            ...
            WHEN d.SD_STOCK IS NOT NULL AND i.IM_CUST = 'TABCORP' AND IU_TO_METRIC = 1 THEN (SELECT To_Number(regexp_substr(RM_XX_FEE08,'^[-]?[[:digit:]]*\.?[[:digit:]]*$')) FROM RM where RM_CUST = sCustomerCode) --* d.SD_QTY_DESP --EOM_REPORT_PKG_TEST.F_BREAK_UNIT_PRICE(r.sGroupCust,d.SD_STOCK) IS NOT NULL THEN EOM_REPORT_PKG_TEST.F_BREAK_UNIT_PRICE(r.sGroupCust,d.SD_STOCK)
            ...
            WHEN d.SD_STOCK IS NOT NULL AND i.IM_CUST = 'TABCORP' AND IU_TO_METRIC = 1 THEN (SELECT To_Number(regexp_substr(RM_XX_FEE08,'^[-]?[[:digit:]]*\.?[[:digit:]]*$')) FROM RM where RM_CUST = sCustomerCode) * l.SL_PSLIP_QTY --EOM_REPORT_PKG_TEST.F_BREAK_UNIT_PRICE(r.sGroupCust,d.SD_STOCK) IS NOT NULL THEN EOM_REPORT_PKG_TEST.F_BREAK_UNIT_PRICE(r.sGroupCust,d.SD_STOCK)
            ...
            WHEN d.SD_STOCK IS NOT NULL AND i.IM_CUST = 'TABCORP' AND IU_TO_METRIC = 1 THEN (((SELECT To_Number(regexp_substr(RM_XX_FEE08,'^[-]?[[:digit:]]*\.?[[:digit:]]*$')) FROM RM where RM_CUST = sCustomerCode) * l.SL_PSLIP_QTY) * 1.1) --EOM_REPORT_PKG_TEST.F_BREAK_UNIT_PRICE(r.sGroupCust,d.SD_STOCK) IS NOT NULL THEN EOM_REPORT_PKG_TEST.F_BREAK_UNIT_PRICE(r.sGroupCust,d.SD_STOCK)
            ...
            ELSE NULL
            END          AS "DIncl",
            CASE WHEN sCustomerCode = 'TABCORP' Then EOM_REPORT_PKG_TEST.F_BREAK_UNIT_PRICE(r.OW_CAT,d.SD_STOCK)
                 WHEN sCustomerCode = 'TABCORP' AND EOM_REPORT_PKG_TEST.F_BREAK_UNIT_PRICE(r.OW_CAT,d.SD_STOCK) IS NULL Then To_Number(i.IM_REPORTING_PRICE)
    ...
    PROCEDURE G2_STOCK_FEES_SD (
      ...
      SELECT 
          ...
          substr(To_Char(s.SH_ADD_DATE),0,10) AS "OrderDate",
            ...
            ELSE NULL
            END          AS "DIncl",
            CASE WHEN sCustomerCode = 'TABCORP' Then EOM_REPORT_PKG_TEST.F_BREAK_UNIT_PRICE(r.RM_GROUP_CUST,d.SD_STOCK)
                 WHEN sCustomerCode = 'TABCORP' AND EOM_REPORT_PKG_TEST.F_BREAK_UNIT_PRICE(r.RM_GROUP_CUST,d.SD_STOCK) IS NULL Then To_Number(i.IM_REPORTING_PRICE)
            Else To_Number(i.IM_REPORTING_PRICE)      
            END AS "ReportingPrice", -- break 
            IM_STD_COST,
            IM_LAST_COST,
    ...
    PROCEDURE G4_HANDLING_FEES_F (
      ...
      SELECT
            ...
            NULL As   Cost,
            s.SH_SPARE_INT_4 AS PaymentType,s.SH_CAMPAIGN,NULL,NULL,NULL
      --  FROM  ST t LEFT JOIN PWIN171.SH s ON  LTrim(s.SH_ORDER) = LTrim(t.ST_ORDER)
        --    LEFT JOIN Tmp_Group_Cust r ON r.sCust = s.SH_CUST
  ...
  FROM  ST t LEFT JOIN PWIN171.SH s ON  s.SH_ORDER = t.ST_ORDER
  ...
  END G5_PICK_FEES_F2;
    ...
    SELECT    RM_CUST                AS "Customer",
      ...
      CASE    WHEN RD_CUST IS NOT NULL THEN 'DB Maint fee '
         ...
         TO_NUMBER( (SELECT Count(RD_CODE) FROM PWIN171.RD WHERE RD_CUST IN ( SELECT RM_CUST FROM PWIN171.RM WHERE (RM_PARENT = sCustomerCode) AND SubStr(RD_CODE,0,2) NOT LIKE 'WH'  AND RD_CODE <> 'DIRECT')))  AS "Qty",
      '1'           AS "UOI",
       ...
       (SELECT To_Number(regexp_substr(RM_XX_FEE21,'^[-]?[[:digit:]]*\.?[[:digit:]]*$')) FROM RM where RM_CUST = sCustomerCode) * (SELECT Count(RD_CODE) FROM PWIN171.RD WHERE RD_CUST IN ( SELECT RM_CUST FROM PWIN171.RM WHERE (RM_PARENT = sCustomerCode) AND SubStr(RD_CODE,0,2) NOT LIKE 'WH'  AND RD_CODE <> 'DIRECT'))         AS "DExcl",
      ( (SELECT To_Number(regexp_substr(RM_XX_FEE21,'^[-]?[[:digit:]]*\.?[[:digit:]]*$')) FROM RM where RM_CUST = sCustomerCode) * (SELECT Count(RD_CODE) FROM PWIN171.RD WHERE RD_CUST IN ( SELECT RM_CUST FROM PWIN171.RM WHERE (RM_PARENT = sCustomerCode) AND SubStr(RD_CODE,0,2) NOT LIKE 'WH'  AND RD_CODE <> 'DIRECT'))) * 1.1         AS "DIncl",
  ...
  /*BB PackingFee*/
    ...
    FROM      PWIN171.SD d
          INNER JOIN PWIN171.SH s  ON s.SH_ORDER  = d.SD_ORDER
          INNER JOIN PWIN171.ST t  ON t.ST_ORDER  = s.SH_ORDER  AND t.ST_PICK = d.SD_LAST_PICK_NUM
          LEFT JOIN PWIN171.SL l   ON l.SL_PICK   = t.ST_PICK
  ...
  SELECT    s.SH_CUST               AS "Customer",
          ...
          d.SD_XX_FREIGHT_CHARGE
     FROM      PWIN171.SD d
          RIGHT JOIN PWIN171.SH s  ON s.SH_ORDER  = d.SD_ORDER
          LEFT JOIN PWIN171.ST t  ON t.ST_PICK  = d.SD_LAST_PICK_NUM
          LEFT JOIN PWIN171.SL l   ON l.SL_PICK   = t.ST_PICK
          LEFT JOIN Tmp_Group_Cust r ON r.sCust = s.SH_CUST
          INNER JOIN PWIN171.IM i  ON i.IM_STOCK = d.SD_STOCK
  ...
  UNION ALL
   ...
   Pallet In Fee*/
    ...
    FROM      PWIN171.IM
          ...
          INNER JOIN PWIN171.NE  ON NE_ACCOUNT  = NA_ACCOUNT AND NA_EXT_TYPE = '1210067'
   ...
   (SELECT To_Number(regexp_substr(RM_XX_FEE15,'^[-]?[[:digit:]]*\.?[[:digit:]]*$')) FROM RM where RM_CUST = sCustomerCode) > 0
    ...
    AS
      ...
      SELECT    substr(To_Char(ST.ST_DESP_DATE),0,10) AS "DespatchDate"
               ...
               NULL,NULL,NULL,NULL
      FROM  PWIN171.SD
            RIGHT JOIN PWIN171.SH  ON SH.SH_ORDER  = SD.SD_ORDER
            LEFT JOIN PWIN171.ST  ON ST.ST_PICK  = SD.SD_LAST_PICK_NUM
            LEFT JOIN PWIN171.SL   ON SL.SL_PICK   = ST.ST_PICK
            INNER JOIN PWIN171.RM  ON RM.RM_CUST  = SH.SH_CUST
            --INNER JOIN PWIN171.RD  ON RD.RD_CODE  = SH.SH_DEL_CODE
            INNER JOIN Tmp_Group_Cust ON Tmp_Group_Cust.sCust = SH.SH_CUST
            INNER JOIN PWIN171.IM  ON IM.IM_STOCK = SD.SD_STOCK
            INNER JOIN PWIN171.NI  ON NI.NI_NV_EXT_KEY = SL.SL_UID
  ...
  nCheckpoint := 2;
	...
	*/
	...
	BEGIN
		nCheckpoint := 1;
		If (sOp = 'PRJ' or sOp = 'PRJ_TEST') Then
			v_query  := 'TRUNCATE TABLE "PWIN171"."DEV_ALL_FEES"';
		Else
			v_query  := 'TRUNCATE TABLE "PWIN171"."TMP_ALL_FEES"';
		End If;
		EXECUTE IMMEDIATE v_query;
