ALTER PROCEDURE WMS_SOU(@EditDate DATETIME) 
AS BEGIN
SELECT 
'SOH' SOH,
...
WHERE Ord.[MODIFIED_DATE] = '2016-11-14 12:40:07.000'
...
DECLARE @EditDate DATE;
SET @EditDate = CONVERT(VARCHAR(10), '2016-11-14 12:40:07.000', 101);

EXEC WMS_SOU '2016-11-14 12:40:07.000';