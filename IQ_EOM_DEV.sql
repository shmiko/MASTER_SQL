CREATE OR REPLACE PACKAGE IQ_EOM_DEV AS 
...
CREATE OR REPLACE PACKAGE BODY IQ_EOM_DEV AS
    ...
    nCheckpoint := 5;
      ...
      If F_IS_TABLE_EEMPTY('DEV_ALL_FREIGHT_ALL') <= 0 Then
        --DBMS_OUTPUT.PUT_LINE(''
         ...
         -- || ' Need to RUN_ONCE F_EOM_DEV_ALL_FREIGHT_ALL & F8_Z_EOM_RUN_FREIGHT for all customers as table is empty.'
      ...
      Then
        --DBMS_OUTPUT.PUT_LINE(''
        --  || '5th this suggests that BOTH the bulk freight data AND the customer freight data is NOT fresh - re run both!!!'
        --  || ' Need to RUN_ONCE F_EOM_DEV_ALL_FREIGHT_ALL & F8_Z_EOM_RUN_FREIGHT for all customers as table is not empty.'
        --  || ' Last Cust match was ' ||  UPPER(v_query_result2) 
        --  || ' and this cust was ' ||  UPPER(sCust_start)
        --  || ' and to date was ' ||  UPPER(v_query_logfile)
         -- || ' and this date was ' ||  UPPER(v_tmp_date) 
      ...
      --  AND UPPER(v_query_logfile) IS NOT NULL 
       ...
       -- Then
         ...
         -- || ' No Need to RUN_ONCE F_EOM_DEV_ALL_FREIGHT_ALL & F8_Z_EOM_RUN_FREIGHT for all customers as table is not empty.'
         -- || ' Last Cust match was ' ||  UPPER(v_query_result2) 
         -- || ' and this cust was ' ||  UPPER(sCust_start)
         -- || ' and to date was ' ||  UPPER(v_query_logfile)
         -- || ' and this date was ' ||  UPPER(v_tmp_date) 
        ...
        Then
         ...
         -- || ' Need to RUN_ONCE F_EOM_DEV_ALL_FREIGHT_ALL & F8_Z_EOM_RUN_FREIGHT for all customers as table is from different dates and different customer.' 
        ...
        --DBMS_OUTPUT.PUT_LINE(''
         ...
         -- );
          ...
          IQ_EOM_DEV.F8_Z_EOM_RUN_FREIGHT(p_array_size_start,start_date,end_date,sCust_start,sFilterBy);      
       -- Else
          --DBMS_OUTPUT.PUT_LINE('5th No matches for running F_EOM_DEV_ALL_FREIGHT_ALL & F8_Z_EOM_RUN_FREIGHT,' 
