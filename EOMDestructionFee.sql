...
exec :start_date := To_Date('15-Jul-2013')
var end_date varchar2(20)
exec :end_date := To_Date('21-Jul-2013')
...
SELECT    s.SH_CUST                AS "Customer",
  ...
  CASE    /* Get Packing Fees If stock is of type BB_PACK then charge sRM_XX_FEE08.AsDouble * SL_PSLIP_QTY  */
	       WHEN s.SH_NOTE_1 = 'DESTROY' OR s.SH_CAMPAIGN = 'OBSOLETE' THEN '' ||  (Select RM_XX_FEE25 from RM where RM_CUST = :cust)
         ELSE ''
         END                      AS "UnitPrice",
         d.SD_EXCL                AS "DExcl",
