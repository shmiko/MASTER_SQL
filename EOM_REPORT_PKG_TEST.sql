CREATE OR REPLACE PACKAGE EOM_REPORT_PKG_TEST
IS
    TYPE tst_tmp_admin_tbl is table of  Tmp_Admin_Data_BreakPrices%rowtype INDEX BY BINARY_INTEGER;
    TYPE tst_tmp_Group_Cust is table of  Tmp_Group_Cust%rowtype INDEX BY BINARY_INTEGER;
    TYPE tst_tmp_Admin_Data_Pickslips is table of  Tmp_Admin_Data_Pickslips%rowtype INDEX BY BINARY_INTEGER;
    TYPE tst_tmp_Admin_Data_Pick_Counts is table of  Tmp_Admin_Data_Pick_LineCounts%rowtype INDEX BY BINARY_INTEGER;
    TYPE tst_tmp_Locn_Cnt_By_Cust is table of  Tmp_Locn_Cnt_By_Cust%rowtype INDEX BY BINARY_INTEGER;
  ...
  PROCEDURE F_EOM_TMP_ALL_FREIGHT_ALL (
    ...
    PROCEDURE F_EOM_TMP_AUTO_FREIGHT_ALL (
      p_array_size IN PLS_INTEGER DEFAULT 100
      ,startdate IN VARCHAR2-- := To_Date('1-Jun-2015')-- use this when you want the date entered automatically
      ,enddate IN VARCHAR2-- := To_Date('30-Jun-2015')
      ,sCustomerCode IN VARCHAR2
    );
